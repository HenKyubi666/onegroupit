...
var createProduct = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, name, price, imgUrl, dateOfExpiration, calification, userId, newProduct;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _req$body = req.body, name = _req$body.name, price = _req$body.price, imgUrl = _req$body.imgUrl, dateOfExpiration = _req$body.dateOfExpiration, calification = _req$body.calification, userId = _req$body.userId;
